"""
Kanokphan — individual spending analysis page.
"""
...
with st.sidebar:
    ...
    up_bank = st.file_uploader("Bank statement CSVs", type="csv", accept_multiple_files=True, key="k_bank")
    up_cc = st.file_uploader("Credit card CSVs", type="csv", accept_multiple_files=True, key="k_cc")
    ...
    if not _tmp.empty:
        all_cats = sorted(_tmp["Category"].unique().tolist())
